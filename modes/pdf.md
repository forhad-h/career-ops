...
7. Rewrite Professional Summary injecting JD keywords + exit narrative bridge ("Built production AI systems at scale. Now applying that to [JD domain].")
